...
class AppController(TCPServer):
    ...
    def send_parameters(self):
        ...
        msg["fps_resolution"] = self.app_settings.run_settings.fps_resolution
        msg["matrix"] = self.app_settings.matrix.serialize()
        self.send_command(msg)


    def notify_selection(self, selection_uid, selection_cycle):
        print(self.TAG, "Notifying selection at cycle %i: %s" %
              (selection_cycle, selection_uid))
        msg = dict()
